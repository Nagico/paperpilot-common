...
from paperpilot_common.core.cache.backends.base import DEFAULT_TIMEOUT, BaseCache
from paperpilot_common.db import DatabaseError, connections, models, router, transaction
from paperpilot_common.utils.timezone import now as tz_now


class Options:
    """A class that will quack like a Paperpilot model _meta class.
    ...
    def __init__(self, table):
        self.db_table = table
        self.app_label = "paperpilot_common_cache"
