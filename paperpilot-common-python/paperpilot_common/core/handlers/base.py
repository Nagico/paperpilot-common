...
from paperpilot_common.core.exceptions import ImproperlyConfigured, MiddlewareNotUsed
from paperpilot_common.core.signals import request_finished
from paperpilot_common.db import connections, transaction
from paperpilot_common.urls import get_resolver, set_urlconf
...
logger = logging.getLogger("paperpilot_common.request")
