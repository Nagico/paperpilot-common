...
from paperpilot_common.core.files.base import ContentFile
...
from paperpilot_common.utils.timezone import now
...
@deconstructible(path="paperpilot_common.core.files.storage.InMemoryStorage")
