from paperpilot_common.conf import DEFAULT_STORAGE_ALIAS, STATICFILES_STORAGE_ALIAS, settings
    ...
    def backends(self):
        if self._backends is None:
            ...
            if settings.is_overridden("STATICFILES_STORAGE"):
                self._backends[STATICFILES_STORAGE_ALIAS] = {"BACKEND": settings.STATICFILES_STORAGE}
