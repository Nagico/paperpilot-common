...
be executed through ``paperpilot_common-admin`` or ``manage.py``).
"""
import argparse
import os
import sys
...
class PaperpilotHelpFormatter(HelpFormatter):
    """
...
class BaseCommand:
    ...
    1. ``paperpilot_common-admin`` or ``manage.py`` loads the command class
    ...
    def get_version(self):
        """
        Return the Paperpilot version, which should be correct for all built-in
        Paperpilot commands. User-supplied commands can override this method to
        return their own version.
        """
        return paperpilot_common.get_version()
    ...
    def create_parser(self, prog_name, subcommand, **kwargs):
        ...
        """
        kwargs.setdefault("formatter_class", PaperpilotHelpFormatter)
        ...
        self.add_base_argument(
            ...
            help=(
                ...
                "SERVER_SETTINGS_MODULE environment variable will be used."
            ),
        )
        self.add_base_argument(
            parser,
            "--pythonpath",
            help=("A directory to add to the Python path, e.g. " '"/home/paperpilot_commonprojects/myproject".'),
        )
        self.add_base_argument(
            parser,
            "--traceback",
    ...
    def run_from_argv(self, argv):
        ...
        and Paperpilot settings), then run this command. If the
    ...
    def check(
        ...
        """
        Use the system check framework to validate entire Paperpilot project.
