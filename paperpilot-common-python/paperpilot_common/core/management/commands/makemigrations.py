...
from paperpilot_common.core.management.base import BaseCommand, CommandError, no_translations
from paperpilot_common.core.management.utils import run_formatters
from paperpilot_common.db import DEFAULT_DB_ALIAS, OperationalError, connections, router
from paperpilot_common.db.migrations import Migration
from paperpilot_common.db.migrations.autodetector import MigrationAutodetector
from paperpilot_common.db.migrations.loader import MigrationLoader
from paperpilot_common.db.migrations.migration import SwappableTuple
from paperpilot_common.db.migrations.optimizer import MigrationOptimizer
from paperpilot_common.db.migrations.questioner import (
    InteractiveMigrationQuestioner,
    MigrationQuestioner,
    NonInteractiveMigrationQuestioner,
)
from paperpilot_common.db.migrations.state import ProjectState
from paperpilot_common.db.migrations.utils import get_migration_name_timestamp
from paperpilot_common.db.migrations.writer import MigrationWriter
...
class Command(BaseCommand):
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument(
            ...
            action="store_false",
            dest="interactive",
            help="Tells Paperpilot to NOT prompt the user for input of any kind.",
        )
        parser.add_argument(
            "-n",
            "--name",
        ...
        parser.add_argument(
            ...
            dest="check_changes",
            help=(
                "Exit with a non-zero status if model changes are missing migrations " "and don't actually write them."
            ),
        )
        parser.add_argument(
            "--scriptable",
    ...
    def handle(self, *app_labels, **options):
        ...
        for alias in sorted(aliases_to_check):
            ...
            if connection.settings_dict["ENGINE"] != "paperpilot_common.db.backends.dummy" and any(
