...
from paperpilot_common.db.models.constants import LOOKUP_SEP


class Command(BaseCommand):
    help = "Introspects the database tables in the given database and outputs a Paperpilot " "model module."
    requires_system_checks = []
    stealth_options = ("table_name_filter",)
    db_module = "paperpilot_common.db"
    ...
    def handle_inspection(self, options):
        ...
        with connection.cursor() as cursor:
            yield "# This is an auto-generated Paperpilot model module."
            ...
            yield (
                ...
                "Paperpilot to create, modify, and delete the table"
            )
