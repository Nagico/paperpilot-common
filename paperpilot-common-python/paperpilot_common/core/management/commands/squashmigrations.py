...
from paperpilot_common.db import DEFAULT_DB_ALIAS, connections, migrations
from paperpilot_common.db.migrations.loader import AmbiguityError, MigrationLoader
        ...
        for smigration in migrations_to_squash:
            if smigration.replaces:
                raise CommandError(
                    ...
                    "normal migration first: https://docs.paperpilot_commonproject.com/en/%s/"
