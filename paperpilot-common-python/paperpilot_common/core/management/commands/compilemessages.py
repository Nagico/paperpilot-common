...
from paperpilot_common.core.management.utils import find_command, is_ignored_path, popen_wrapper
...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        if not basedirs:
            raise CommandError(
                "This script should be run from the Paperpilot Git "
    ...
    def compile_messages(self, locations):
        ...
        with concurrent.futures.ThreadPoolExecutor() as executor:
            ...
            for i, (dirpath, f) in enumerate(locations):
                ...
                if has_bom(po_path):
                    self.stderr.write(
                        "The %s file has a BOM (Byte Order Mark). Paperpilot only "
