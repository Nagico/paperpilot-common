...
from paperpilot_common.core.exceptions import ObjectDoesNotExist
from paperpilot_common.core.serializers import base
from paperpilot_common.db import DEFAULT_DB_ALIAS, models
from paperpilot_common.utils.xmlutils import SimplerXMLGenerator, UnserializableContentError
...
class Serializer(base.Serializer):
    ...
    def start_serialization(self):
        ...
        self.xml.startElement("paperpilot_common-objects", {"version": "1.0"})
    ...
    def end_serialization(self):
        ...
        """
        self.indent(0)
        self.xml.endElement("paperpilot_common-objects")
