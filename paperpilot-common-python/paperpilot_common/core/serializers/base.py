...
from paperpilot_common.utils.deprecation import RemovedInPaperpilot50Warning
...
class PickleSerializer:
    ...
    def __init__(self, protocol=None):
        warnings.warn(
            "PickleSerializer is deprecated due to its security risk. Use " "JSONSerializer instead.",
            RemovedInPaperpilot50Warning,
        )
