...
from paperpilot_common.core.checks import Error, Warning
from paperpilot_common.core.checks.urls import check_resolver
from paperpilot_common.core.exceptions import ImproperlyConfigured, ViewDoesNotExist
from paperpilot_common.utils.datastructures import MultiValueDict
from paperpilot_common.utils.functional import cached_property
from paperpilot_common.utils.regex_helper import _lazy_re_compile, normalize

from ..utils.http import RFC3986_SUBDELIMS, escape_leading_slashes
...
class URLResolver:
    ...
    def resolve_error_handler(self, view_type):
        ...
        if not callback:
            ...
            from paperpilot_common.conf import urls
