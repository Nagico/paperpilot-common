...
from paperpilot_common.core.exceptions import AppRegistryNotReady, ImproperlyConfigured
...
class Apps:
    ...
    # This method is performance-critical at least for Paperpilot's test suite.
    ...
    def is_installed(self, app_name):
        ...
        app_name is the full name of the app e.g. 'paperpilot_common.contrib.admin'.
        """
        self.check_apps_ready()
    ...
    def get_swappable_settings_name(self, to_string):
        ...
        change after Paperpilot has loaded the settings, there is no reason to get
